[![Netlify Status](https://api.netlify.com/api/v1/badges/cca097aa-7f3c-4389-bc04-7922f7d140da/deploy-status)](https://app.netlify.com/sites/spectacular-elf-c21ac8/deploys)

# ☕ STARBUCKS

스타벅스 랜딩 페이지(홈페이지)를 만드는 예제입니다. <br>
※ Fastcampus 박영웅님의 한 번에 끝내는 HTML, CSS, JavaScript, TypeScript 강의

- [Deployed App by netlify](https://spectacular-elf-c21ac8.netlify.app/)
